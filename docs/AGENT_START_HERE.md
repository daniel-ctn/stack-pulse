...
| Notifications | `/settings` — one Slack/Discord webhook per user (`user_webhooks`), importance threshold; cron dispatches new releases post-run. See [features/notifications.md](./features/notifications.md). |
