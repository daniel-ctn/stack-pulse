        ...
        <div className="frame overflow-hidden">
          ...
          <div className="px-6 py-7">
            ...
            <button
              ...
              disabled={loading}
              className="mt-7 w-full rounded-md bg-lime px-4 py-3 font-mono text-[13px] font-semibold text-void hover:bg-lime/85 transition-colors disabled:opacity-60 inline-flex items-center justify-center gap-2.5"
            >
