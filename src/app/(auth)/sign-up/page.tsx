      ...
      <div className="w-full max-w-md animate-fade-up">
        ...
        <div className="frame overflow-hidden">
          <div className="frame-titlebar">
            ...
            <span className="text-dust">~/auth/register.sh</span>
            <span className="ml-auto text-mute">init</span>
          </div>

          <div className="px-6 py-7">
            <div className="font-mono text-[11px] text-fade tracking-[0.2em] uppercase">
              <span className="text-lime">$</span> auth --register
            </div>
            <h1 className="mt-2 font-mono text-2xl font-bold tracking-tight text-ink lowercase">
              create account<span className="text-lime caret" />
            </h1>
            <p className="mt-1.5 text-[13px] text-dust">start tracking your stack in seconds.</p>

            <form onSubmit={handleEmailSignUp} className="mt-7 space-y-4">
              <Field label="name" type="text" value={name} onChange={setName} placeholder="jane smith" />
              ...
              >
                ...
                <span>{loading ? './register --pending' : './register'}</span>
              </button>
            </form>
