    ...
    <main className="flex min-h-screen items-center justify-center px-4">
      <div className="w-full max-w-sm animate-fade-up">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-sm text-fg-muted">Start tracking your stack in seconds</p>
        </div>

        <form action="/api/auth/sign-up/email" method="POST" className="space-y-5">
          <div>
            <label htmlFor="name" className="block text-xs font-medium text-fg-muted mb-1.5">
              Name
            </label>
            <input
              id="name"
